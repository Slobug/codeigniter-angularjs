angular.module('project', ['projectApi']).
  config(function($routeProvider) {
    $routeProvider.
      when('/', {controller:ListCtrl, templateUrl:BASE_URL+'home/web_list'}).
      when('/edit/:id', {controller:EditCtrl, templateUrl:BASE_URL+'home/web_details'}).
      when('/new', {controller:CreateCtrl, templateUrl:BASE_URL+'home/web_details'}).
